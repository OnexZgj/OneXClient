...
public class ArticleTypeAdapter extends BaseQuickAdapter<ArticleTypeContent.DatasBean,BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ArticleTypeContent.DatasBean item) {
